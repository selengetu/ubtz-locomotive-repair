...
class ZasplanController extends Controller
{
    ...
    public function index()
    {
        ...
        $damage=DB::select("select * from SET_GEMTEL");
        ...
        return view('devter.zasunplan')->with(['unit'=>$unit,'part'=>$part, 'locserial' => $locserial, 'startdate' =>$startdate,
    ...
    public function store()
    {
        ...
        $zasplan->reciever =Request::input('reciever');
