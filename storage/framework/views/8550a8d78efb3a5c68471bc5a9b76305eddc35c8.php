<?php $__env->startSection('content'); ?>
        ...
        <center><h4><b>  Гэмтлийн төрөл бүртгэл</b></h4></center>
              <table class="table table-striped table-bordered table-hover"  id="example">
                  <thead style="background-color: #81b5d5; color: #fff">
                  <tr>

                      <th> # </th>
                      <th> Гэмтлийн төрөл</th>
                      <th> Гэмтлийн нэр</th>
                  </tr>
                  </thead>
                  <tbody>
                            ...
                            <?php $no = 1; ?>
                  <?php $__currentLoopData = $gemtel; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $gemtels): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <tr>
                          <td><?php echo e($no); ?></td>
                          <td><?php echo e($gemtels->part_name); ?></td>
                          <td><?php echo e($gemtels->gemtel_name); ?></td>
                      </tr>
                      <?php $no++; ?>
              ...
              <div class="modal-dialog" role="document">
                  <div class="modal-content">
                      <div class="modal-header">
                          <h5 class="modal-title" id="exampleModalLongTitle">Гэмтлийн төрөл бүртгэх</h5>
                          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                              <span aria-hidden="true">&times;</span>
                          </button>
                      </div>
                             <form method="post" action="addgemteltype">
                              ...
                              <div class="col-md-6">
                                ...
                                <div class="form-group form-md-line-input has-success">
                                    <div class="input-icon">
                                        <select class="form-control select2" id="gemtel_type" name="gemtel_type" >
                                      ...
                                      <div class="form-group">
                                          ...
                                          <input type="text" class="form-control inputtext" id="gemtel_name" name="gemtel_name">
                                      </div>
