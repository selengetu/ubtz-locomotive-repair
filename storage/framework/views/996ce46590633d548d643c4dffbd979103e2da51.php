<div class="body"></div>
        ...
        <div class="login">
                ...
                <form class="form-horizontal" method="POST" action="<?php echo e(route('register')); ?>">
                        ...
                        <div class="form-group<?php echo e($errors->has('name') ? ' has-error' : ''); ?>">
                            ...
                            <div class="col-md-6">
                                <input id="name" type="text" class="form-control" name="name" value="<?php echo e(old('name')); ?>" required autofocus placeholder="Нэр">
                     ...
                     <div class="form-group<?php echo e($errors->has('email') ? ' has-error' : ''); ?>">
                            ...
                            <div class="col-md-6">
                                <input id="email" type="email" class="form-control" name="email" value="<?php echo e(old('email')); ?>" required autofocus placeholder="И-мейл хаяг">
        ...
        <style type="text/css">
@font-face {  
     font-family:Perforama; src: url('<?php echo e(asset('fonts/Perforama.otf')); ?>'); 
}
