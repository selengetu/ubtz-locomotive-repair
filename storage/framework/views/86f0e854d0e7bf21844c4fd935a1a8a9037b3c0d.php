    ...
    <div class="col-md-3">
                                  ...
                                  <div class="col-md-3">
                                      ...
                                      <div class="form-group">
                                          ...
                                          <input type="text" class="form-control inputtext" id="stopday" name="stopday" readonly="true">
                                      </div>
                                  ...
                                  <div class="col-md-3">
                                      <div class="form-group">
                                          ...
                                          <input type="text" class="form-control inputtext" id="priority" name="priority" readonly="true">
                                      </div>
