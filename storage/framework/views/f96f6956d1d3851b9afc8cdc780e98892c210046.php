              ...
              <table class="table table-striped table-bordered table-hover"  id="example">
                  ...
                  <?php $__currentLoopData = $zasunplan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $zasunplans): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <tr>
                          ...
                          <td><?php echo e($zasunplans->solilt_zutnumber); ?></td>

                          <td><?php if($zasunplans->solilt_zastype == 1): ?>
                                  Төлөвлөгөөт
                              <?php elseif($zasunplans->solilt_zastype == 2): ?>
                                  Төлөвлөгөөт бус
                              <?php elseif($zasunplans->solilt_zastype == 3): ?>
                                  Хоорондын засвар
                              <?php endif; ?>
                          </td>
                          ...
                          <td>
                              <?php if($zasunplans->solilt_depo == 1): ?>
                                  ТЧ-1
