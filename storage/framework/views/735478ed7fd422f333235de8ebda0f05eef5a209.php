                            ...
                            <table class="table table-striped table-bordered table-hover"  id="example">
                                ...
                                <?php $__currentLoopData = $zasplan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $zasplans): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr class="zasplan" data-id="<?php echo e($zasplans->repairid); ?>" tag="<?php echo e($zasplans->repairid); ?>">
                                        ...
                                        <td><?php echo e($zasplans->receiver_name); ?></td>
                                        <?php if($zastype ==2 ): ?> 
              ...
              <div class="modal-dialog modal-lg" role="document">
                  <div class="modal-content">
                      <div class="modal-header">
                          <h5 class="modal-title" id="exampleModalLongTitle">  <?php if($zastype ==1 ): ?> 
                        Төлөвлөгөөт засвар
                        <?php elseif($zastype ==2 ): ?> 
                        Төлөвлөгөөт бус засвар 
                        <?php endif; ?>бүртгэх</h5>
                          ...
                          <div class="tab-content">
                              <div id="home" class="tab-pane fade in active">
                                  <form method="post" action="addzasplan" id="formzasplan">
                                      ...
                                      <?php echo e(csrf_field()); ?>
                                          ...
                                          <div class="col-md-3">
                                              <div class="form-group">
                                                  <label for="name">Зүтгүүрийн сери</label>
                                                  <input class="form-control hidden" id="zastype" name="zastype" type="text" value="<?php echo e($zastype); ?>">
                                              ...
                                              <div class="form-group">
                                                  ...
                                                  <select class="form-control select2" id="repid" name="repid" >
                                                      <?php $__currentLoopData = $rep; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $reps): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                          <option value= "<?php echo e($reps->repid); ?>" tag="<?php echo e($reps->repshname); ?>"> <?php echo e($reps->repshname); ?> - <?php echo e($reps->repname); ?></option>
                                                      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                  </select>
                                              </div>
                                          ...
                                          <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <label for="form_control_1">
                                                        ...
                                                        <input class="form-control datepicker" id="repindate" name="repindate" type="text" value="<?php echo e($enddate); ?>">
                                                ...
                                                <div class="form-group">
                                                    <div class="input-icon">
                                                        ...
                                                        <input class="form-control datepicker" id="repoutdate" name="repoutdate" type="text" value="<?php echo e($enddate); ?>">
                                                    </div>
                                                </div>
                                            </div>
                                          ...
                                          <div class="col-md-3">
                                              <div class="form-group">
                                                  ...
                                                  <select class="form-control select2" id="receiver" name="receiver">
                                                      <?php $__currentLoopData = $receiver; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $receivers): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                          <option value= "<?php echo e($receivers->receiver_id); ?>"><?php echo e($receivers->receiver_name); ?></option>
                                                      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                  </select>
                                              </div>
                                  ...
                                  <?php $__currentLoopData = $depo; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $depos): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> 
                                       <option value= "<?php echo e($depos->depocode); ?>"><?php echo e($depos->deponame); ?></option>
                                   <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
          </select>
                                              </div>
                                          ...
                                          <div class="col-md-3">
                                              <div class="form-group">
                                                  ...
                                                  <input class="form-control datepicker" id="replastdate" name="replastdate" type="text" value="<?php echo e($enddate); ?>">
                                              </div>
