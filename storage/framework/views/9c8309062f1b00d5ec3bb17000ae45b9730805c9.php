...
<?php $__env->startSection('content'); ?>
          ...
          <div class="dataTables_wrapper form-inline dt-bootstrap no-footer" id="printarea">
              <p><center><b> <?php echo e($startdate); ?>  <?php echo e($enddate); ?> -ын засварын төлөвлөгөө</b></center> </p>
              <table class="table table-striped table-bordered table-hover"  id="example">
                  ...
                  <?php $__currentLoopData = $zastul; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $zastuls): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <tr>
                          ...
                          <td><?php echo e($zastuls->depocode); ?></td>
                          <td><?php echo e($zastuls->seriname); ?></td>
                          <td><?php echo e($zastuls->repid); ?></td>
                              ...
                              <div class="col-md-12">
                                  ...
                                  <div class="col-md-3">
                                      <div class="form-group">
                                          ...
                                          <select class="form-control select2" id="seri_code" name="seri_code" onchange="myfunc(this.value)">
