 ...
 <ul class="page-sidebar-menu" data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
                        <li class="nav-item start active open">
                            ...
                            <ul class="sub-menu">
                                <li class="nav-item start active open">
                                    <a href="<?php echo e(route('devedangi')); ?>" class="nav-link ">
                                        <i class="icon-note"></i>
                         ...
                         <li class="nav-item  ">
                             <a href="<?php echo e(route('edangi')); ?>" class="nav-link nav-toggle">
                                 <i class="icon-note"></i>
                                 <span class="title">Нэмэлт ажлын төрөл</span>
                             </a>
                         ...
                         <li class="nav-item  ">
                             <a href="<?php echo e(route('zasunplan')); ?>" class="nav-link nav-toggle">
                                 <i class="icon-note"></i>
                         ...
                         <li class="nav-item  ">
                             <a href="<?php echo e(route('zastul')); ?>" class="nav-link nav-toggle">
                                 <i class="icon-bulb"></i>
     ...
     <li class="nav-item  ">
         <a href="<?php echo e(route('nasjilt')); ?>" class="nav-link nav-toggle">
             ...
             <span class="title">Эд ангийн насжилтийн судалгаа</span>

         </a>

     </li>
     <li class="nav-item  ">
         <a href="<?php echo e(route('zas')); ?>" class="nav-link nav-toggle">
             <i class="icon-bar-chart"></i>
