            ...
            <div class="table-container">
                <div class="dataTables_wrapper form-inline dt-bootstrap no-footer" id="printarea">
                    ...
                    <table class="table table-striped table-bordered table-hover"  id="example">
                        ...
                        <?php $no = 1; ?>
                        <?php $__currentLoopData = $zasrun; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $zasruns): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <td><?php echo e($no); ?></td>
                                <td><?php echo e($zasruns->seriname); ?> - <?php echo e($zasruns->zutnumber); ?></td>
                                <td><?php echo e($zasruns->repshname); ?></td>
                                <td><?php echo e($zasruns->replastdate); ?></td>
                                <td><?php echo e(number_format($zasruns->runkm,2)); ?></td>
                                <td><?php echo e(number_format($zasruns->begrun,2)); ?></td>
                            </tr>
                            <?php $no++; ?>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
