<?php $__env->startSection('content'); ?>
          ...
          <div class="table-responsive" id="printarea">
              <p><center><b> <?php echo e($startdate); ?> -аас <?php echo e($enddate); ?> -ны засвар</b></center> </p>
              <table class="table table-striped table-bordered table-hover"  id="example">
                  ...
                  <tr>
                      ...
                      <td><?php echo e($zasunplans->seriname); ?> - <?php echo e($zasunplans->solilt_zutnumber); ?></td>
                      <td><?php echo e($zasunplans->solilt_sekts); ?> - <?php echo e($zasunplans->solilt__sekts_num); ?></td>
                      <td><?php echo e($zasunplans->solilt_begintime); ?></td>
                      <td><?php echo e($zasunplans->solilt_endtime); ?></td>

                      <td><?php echo e($zasunplans->rep_name); ?></td>
                      <td>
                          <?php if($zasunplans->solilt_depo == 5): ?>
                              ТЧ-1
                          <?php elseif($zasunplans->solilt_depo == 2): ?>
                              ТЧ-2
                          <?php elseif($zasunplans->solilt_depo == 3): ?>
                              ТЧ-3
                          <?php elseif($zasunplans->solilt_depo == 1): ?>
                              Сүхбаатар
                          <?php elseif($zasunplans->solilt_depo == 13): ?>
                              Замын-Үүд
                          <?php endif; ?>
                              </td>
                      <td><?php echo e($zasunplans->gemtel_name); ?></td>
                      <td>      <?php $__currentLoopData = $zasdetail; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $zasdetails): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                              <?php if($zasunplans->solilt_id == $zasdetails->solilt_id): ?>
                                  <?php echo e($zasdetails->seri_name); ?> -  <?php echo e($zasdetails->solilt_num); ?>  <br>
                              <?php endif; ?>
                          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?></td>
                      <td>      <?php $__currentLoopData = $zasdetail; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $zasdetails): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                              <?php if($zasunplans->solilt_id == $zasdetails->solilt_id): ?>
                                  <?php echo e($zasdetails->eseri_name); ?>  -  <?php echo e($zasdetails->solilt_enum); ?> <br>
                              <?php endif; ?>
                          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?></td>
                      <td>      <?php $__currentLoopData = $zasdetail; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $zasdetails): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                              <?php if($zasunplans->solilt_id == $zasdetails->solilt_id): ?>
                                  <?php echo e($zasdetails->part_name); ?>  <br>
                              <?php endif; ?>
                          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?></td>

                      <td><a class='btn btn-xs btn-info update' data-toggle='modal' data-target='#myModalup' data-id="<?php echo e($zasunplans->solilt_id); ?>" tag=" <?php echo e($zasunplans->solilt_id); ?> "><span class='glyphicon glyphicon-pencil'></span></a><a class='btn btn-xs btn-danger' tag="<?php echo e($zasunplans->solilt_id); ?>"  href="<?php echo e(route('zasunplan.destroy', $zasunplans->solilt_id)); ?>" onclick="return confirm('Энэ засварыг устгах уу?')" ><span class='glyphicon glyphicon-trash'></span></a></td>
                                              ...
                                              <div class="form-group">
                                                  ...
                                                  <select class="form-control select2" id="zas_rep" name="zas_rep" >
                                                      <?php $__currentLoopData = $rep; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $reps): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                          <option value= "<?php echo e($reps->rep_id); ?>" tag="<?php echo e($reps->rep_name); ?>"> <?php echo e($reps->rep_name); ?></option>
                                                      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                  </select>
                                              </div>
                                          ...
                                          <div class="col-md-3">
                                              <div class="form-group">
                                                  ...
                                                  <select class="form-control select2" id="zas_gemtel" name="zas_gemtel" >
                                                      ...
                                                      <?php $__currentLoopData = $break; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $breaks): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                          <option value= "<?php echo e($breaks->gemtel_id); ?>" tag="<?php echo e($breaks->gemtel_id); ?>"> <?php echo e($breaks->gemtel_type); ?>-<?php echo e($breaks->gemtel_name); ?></option>
                                                      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                  </select>
                                              </div>
