...
<?php $__env->startSection('content'); ?>
  ...
  <div class="tab-content">
                                        ...
                                        <div class="col-md-12">
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <?php $__currentLoopData = $depo; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $depos): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value= "<?php echo e($depos->depocode); ?>" <?php if(Session::get('loc_depo')==$depos->depocode): ?>
                                                        selected <?php endif; ?> ><?php echo e($depos->deponame); ?> </option>
                                                    ...
                                                    <div class="input-icon">
                                                        <select class="form-control select2" id="loc_seri" name="loc_seri" onchange="javascript:location.href = 'filter_loc_seri/'+this.value;" >
                                                            ...
                                                            <?php $__currentLoopData = $locserial; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $locserials): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <option value= "<?php echo e($locserials->sericode); ?>" <?php if(Session::get('loc_seri')==$locserials->
                                sericode): ?> selected <?php endif; ?> ><?php echo e($locserials->seriname); ?> </option>
                                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                        </select>
                                                ...
                                                <div class="form-group form-md-line-input has-success">
                                                    <div class="input-icon">
                                                        <select class="form-control select2" id="loc_number" name="loc_number" onchange="javascript:location.href = 'filter_loc_number/'+this.value;">
                                                            <?php $__currentLoopData = $loc; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $locs): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <option value= "<?php echo e($locs->zutnumber); ?>" <?php if(Session::get('loc_zutnumber')==$locs->zutnumber): ?>
                                                                selected <?php endif; ?>><?php echo e($locs->zutnumber); ?></option>
                                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                        </select>
                                                        <label for="form_control_1" style="font-size:12px;">
                                                                ...
                                                                <div class="input-icon">
                                                                    <select class="form-control select2" id="loc_part" name="loc_part" onchange="javascript:location.href = 'filter_loc_part/'+this.value;">
                                                                     <option value="0">Бүгд</option>
                                                                          <?php $__currentLoopData = $zpart; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $zparts): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                               <option value= "<?php echo e($zparts->part_det_id); ?>" <?php if(Session::get('loc_part')==$zparts->part_det_id): ?>
                                                                               selected <?php endif; ?>><?php echo e($zparts->part_name); ?></option>
                                                                           <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                                     </select>
                                                                    <label for="form_control_1" style="font-size:12px;">
      ...
      <table class="table table-striped table-bordered table-hover"  id="example">
                        ...
                        <?php $no = 1; ?>
                        <?php $__currentLoopData = $zaspart; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $zasparts): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

                                  <tr class="zaspart" onclick="$('#tabdetail').trigger('click')"  data-id="<?php echo e($zasparts->part_id); ?>" tag="<?php echo e($zasparts->part_id); ?>">

                                    <td><?php echo e($no); ?></td>
                                      <td><?php echo e($zasparts->zas_depo); ?></td>
                                      <td><?php echo e($zasparts->seriname); ?>-<?php echo e($zasparts->zas_zutnumber); ?></td>
                                      <td><?php echo e($zasparts->zas_sekts); ?> <?php echo e($zasparts->zas_sekts_num); ?></td>
                                    <td><?php echo e($zasparts->part_name); ?></td>
                                    <td><?php echo e($zasparts->seri_name); ?></td>
                                    <td><?php echo e($zasparts->part_num); ?></td>
                                    <td><?php echo e($zasparts->part_date); ?></td>
                                    <td><?php echo e(round(($zasparts->days / 365),2)); ?> жил</td>
                                      <td><?php echo e(date('Y-m-d', strtotime($zasparts->zas_begindate))); ?></td>
                                      <td><?php echo e($zasparts->zp_guilt); ?></td>
                                      <td><?php echo e($zasparts->tr3_guilt); ?></td>
                                      <td><?php echo e($zasparts->tr3_date); ?></td>
                                      <td><?php echo e($zasparts->tr2_guilt); ?></td>
                                      <td><?php echo e($zasparts->tr2_date); ?></td>
                                      <td><a class="btn btn-xs btn-danger"  href="<?php echo e(route('zaspart.destroy', $zasparts->part_id)); ?>"onclick="return confirm('Энэ эд ангийг устгах уу?')" ><span class="glyphicon glyphicon-trash"></span></a></td>
                                </tr>
                                <?php $no++; ?>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                ...
                <label for="name">Эд ангийн марк</label>
                    <div class="form-group">
                        ...
                        <select class="form-control select2" id="angi_seri" name="angi_seri" >
                            <?php $__currentLoopData = $seri; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $seris): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value= "<?php echo e($seris->seri_id); ?>"><?php echo e($seris->seri_name); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
