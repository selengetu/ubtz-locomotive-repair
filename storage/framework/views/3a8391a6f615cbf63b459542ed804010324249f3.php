        ...
        <div class="panel" >
                                        ...
                                        <div class="col-md-12">
                                                            ...
                                                            <div class="form-group form-md-line-input has-success">
                                                                    ...
                                                                    <input type="text" class="form-control inputtext" id="tuuzmarsh" name="tuuzmarsh" readonly="true" value="1111.111.11">
                                                                    <label for="form_control_1" style="font-size:12px;">
                                                                     Сери дугаар
                                                                    </label>
                                                                    <span class="help-block">
                ...
                <label for="name">Насжилт</label>
                  <input type="text" class="form-control inputtext" id="ilchit" name="ilchit" readonly="true">
                                      ...
                                      <div class="col-md-2">
                                                            <div class="form-group form-md-line-input has-success">
                                       <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>" />
                                       <button class="btn btn-success" style="background-color: #81b5d5; border-color: #81b5d5;"><i class="fa fa-search"></i> Хадгалах</button>
                                     </div>
                                    </div>
                                              </div>
                                          </form>
        ...
        <div class="col-md-12">
         <div class="col-md-3">
              ...
              <div class="col-md-3">
                                      <div class="form-group">
                                          <label for="name">Илчит тэрэгний эд анги</label>
                                          <select class="form-control select2" id="seri_id" name="seri_id" >
            ...
            <div class="col-md-3">
                <div class="form-group">
                    <label for="name">Үйлдвэрлэсэн огноо</label>
                    <input type="text" class="form-control inputtext" id="ed_ognoo" name="ed_ognoo">
                </div>
...
.tooltip:hover .tooltiptext {
    visibility: visible;
            ...
            var itag=$(this).val();
           $.get('getseri/'+itag,function(data){
                 $('#seri_id').empty();
                  
                $.each(data,function(i,qwe){
                
                     $('#seri_id').append($('<option>', {
                        value: qwe.seri_id,
                        id: qwe.seri_id,
                        text: qwe.seri_name
                    })).trigger('change');
