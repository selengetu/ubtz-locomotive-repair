              ...
              <table class="table table-striped table-bordered table-hover"  id="example">
                  ...
                  <?php $__currentLoopData = $zasunplan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $zasunplans): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <tr>
                          ...
                          <td><?php echo e($zasunplans->sec); ?></td>
                          <td><?php echo e($zasunplans->repindate); ?></td>
                          <td><?php echo e($zasunplans->repoutdate); ?></td>

                          <td><?php echo e($zasunplans->repname); ?></td>
                          <td>
                              <?php if($zasunplans->depocode == 5): ?>
                                  ТЧ-1
                              <?php elseif($zasunplans->depocode == 2): ?>
                                  ТЧ-2
                              <?php elseif($zasunplans->depocode == 3): ?>
                                  ТЧ-3
                              <?php elseif($zasunplans->depocode == 1): ?>
                                  Сүхбаатар
                              <?php elseif($zasunplans->depocode == 13): ?>
                                  Замын-Үүд
                              <?php endif; ?>
                          </td>
                          ...
                          <td>      <?php $__currentLoopData = $zasdetail; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $zasdetails): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                  <?php if($zasunplans->repairid == $zasdetails->solilt_id): ?>
