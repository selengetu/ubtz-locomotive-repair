        ...
        <script src="<?php echo e(asset('assets/pages/scripts/components-typeahead.min.js')); ?>" type="text/javascript"></script>
        <script src="<?php echo e(asset('assets/pages/scripts/typeahead.js')); ?>" type="text/javascript"></script>
