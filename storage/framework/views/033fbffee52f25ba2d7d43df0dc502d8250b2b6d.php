                    ...
                    <table class="table table-striped table-bordered table-hover"  id="example">
                        ...
                        <?php $__currentLoopData = $zaspart; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $zasparts): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <tr>
                                ...
                                <td><?php echo e($no); ?></td>
                                <td>
                                    <?php if($zasparts->zas_depo == 5): ?>
                                        ТЧ-1
                                    <?php elseif($zasparts->zas_depo == 2): ?>
                                        ТЧ-2
                                    <?php elseif($zasparts->zas_depo == 3): ?>
                                        ТЧ-3
                                    <?php elseif($zasparts->zas_depo == 1): ?>
                                        Сүхбаатар
                                    <?php elseif($zasparts->zas_depo == 13): ?>
                                        Замын-Үүд
                                    <?php endif; ?>
                                </td>
                                <td><?php echo e($zasparts->seriname); ?></td>
                                <td><?php echo e($zasparts->zas_zutnumber); ?></td>
                                <td><?php echo e($zasparts->zas_sekts); ?></td>
                                <td><?php echo e($zasparts->part_name); ?></td>
                                <td><?php echo e($zasparts->seri_name); ?></td>
                                <td><?php echo e($zasparts->part_num); ?></td>
                                <td><?php echo e($zasparts->guilt+$zasparts->zp_guilt); ?></td>
                                <td> <?php if($zasparts->tr2_guilt != NULL): ?><?php echo e($zasparts->guilt+$zasparts->tr2_guilt); ?> <?php endif; ?></td>
                                <td> <?php if($zasparts->tr3_guilt != NULL): ?><?php echo e($zasparts->guilt+$zasparts->tr3_guilt); ?> <?php endif; ?></td>
                            </tr>
                            <?php $no++; ?>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
