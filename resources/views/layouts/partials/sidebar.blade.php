 ...
 <ul class="page-sidebar-menu" data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
                          ...
                          <li class="heading">
                              <h3 class="uppercase"><b>Тохиргоо</b></h3>
                                 ...
                                 <li class="nav-item  ">
                             <a href="{{ route('devedangi') }}" class="nav-link nav-toggle">
     ...
     <li class="nav-item  ">
         <a href="{{ route('group') }}" class="nav-link nav-toggle">
             <i class="icon-bar-chart"></i>
     ...
     <li class="nav-item  ">
         <a href="{{ route('tsahilgaan') }}" class="nav-link nav-toggle">
             <i class="icon-wrench"></i>
     ...
     <li class="nav-item  ">
         <a href="{{ route('repseri') }}" class="nav-link nav-toggle">
             <i class="icon-bulb"></i>
