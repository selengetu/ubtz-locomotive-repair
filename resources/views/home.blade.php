...
@section('content')
          ...
          <div class="page-content-wrapper">
                ...
                <div class="portlet-title">
                 ...
                 <div class="panel-group accordion" id="accordion">
                                       ...
                                       <button class="btn btn-success" style="background-color: #f13c20; border-color: #f13c20"><i class="fa fa-search"></i> Хайх</button>
                                     </div>
                                    </div>
                                        </div>
      ...
      <table class="table table-striped table-bordered table-hover"  id="example">
                                              <thead style="background-color:#70a1cc; color:#fff">
                                                    <tr>
                                                        <th> # </th>
                                                        <th> Огноо </th>
                                                        <th> Машинч </th>
