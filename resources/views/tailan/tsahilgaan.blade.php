                ...
                <div class="panel">
                         ...
                         >
                                        <div class="col-md-12">
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control select2" id="gemtel_type" name="gemtel_type" value="{{$gemtel_type}}" >
                                       ...
                                       <button class="btn btn-info"  style="background-color: #2EB9A8; border-color: #2EB9A8"><i class="fa fa-search"></i> Хайх</button>
                                            ...
                                            <div class="col-md-12">
                                                <p><center><b> {{$startdate}} -аас {{$enddate}} -ны төлөвлөгөөт бус засварын {{$gru}}-н гэмтлийн судалгаа
                                                    </b></center> </p>
