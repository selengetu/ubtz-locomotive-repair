    ...
    <div class="page-content-wrapper">
        ...
        <div class="page-content">
                ...
                <div id="sear" class="panel-collapse collapse in">
                    <div class="panel-body">
                        <fieldset class="scheduler-border">
                            <form method="post" action="tuslamj">
                                <div class="col-md-12">
                                    <div class="col-md-3">
                                        <div class="form-group form-md-line-input has-success">
                                            <div class="input-icon">
                                                <input class="form-control datepicker" id="tuslamj_from" name="tuslamj_from" type="text"  value="{{$startdate}}" />
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group form-md-line-input has-success">
                                            <div class="input-icon">
                                                <input class="form-control datepicker" id="tuslamj_to" name="tuslamj_to" type="text" value="{{$enddate}}"/>
                                                <label for="form_control_1" style="font-size:12px;">
                                                    Дуусах огноо
                                                </label>
                                                <span class="help-block">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group form-md-line-input has-success">
                                            <div class="input-icon">
                                                <select class="form-control select2" id="tuslamj_type" name="tuslamj_type">
                                                    <option value="0">Бүгд</option>
                                                    <option value="1">Хоорондын зам тусламж авсан</option>
                                                    <option value="2">Хоорондын зам тусламж очсон</option>
                                                    <option value="3">Өртөө тусламж авсан</option>
                                                    <option value="4">Өртөө тусламж очсон</option>
                                                </select>
                                                <label for="form_control_1" style="font-size:12px;">
                                                    Төрөл
                                                </label>
            ...
            <div class="table-container">
                ...
                <p><center><b> {{$startdate}} -аас {{$enddate}} -ны тусламжийн судалгаа</b></center> </p>
...
@section('cscript')
    <script type="text/javascript">
        $(document).ready(function() {
            $("#tuslamj_from").datepicker({
                format: 'yyyy-mm-dd',
                todayBtn:  1,
                autoclose: true,
            }).on('changeDate', function (selected) {
                var minDate = new Date(selected.date.valueOf());
                $('#tuslamj_to').datepicker('setStartDate', minDate);
            });

            $("#tuslamj_to").datepicker({
                format: 'yyyy-mm-dd',
            })
                .on('changeDate', function (selected) {
                    var minDate = new Date(selected.date.valueOf());
                    $('#tuslamj_from').datepicker('setEndDate', minDate);
                });
            $('#example').DataTable( {
                "language": {
    ...
    <script type="text/javascript">
        var tableToExcel = (function () {
            var uri = 'data:application/vnd.ms-excel;base64,'
                , template = '<html xmlns:o="urn:schemas-microsoft-com:office:office" xmlns:x="urn:schemas-microsoft-com:office:excel" xmlns="http://www.w3.org/TR/REC-html40"><head><!--[if gte mso 9]><xml><x:ExcelWorkbook><x:ExcelWorksheets><x:ExcelWorksheet><x:Name>{worksheet}</x:Name><x:WorksheetOptions><x:DisplayGridlines/></x:WorksheetOptions></x:ExcelWorksheet></x:ExcelWorksheets></x:ExcelWorkbook></xml><![endif]--></head><body>     <p><center><b> {{$startdate}} -аас {{$enddate}} -ны тусламжийн судалгаа</b></center> </p><table border="1">{table}</table> <center><b>Нийт: {{$no-1}} удаа {{$i5}} цаг</b></center><span> ТАЙЛАН ГАРГАСАН: Тууз орчуулагч:</span><span style="margin-left: 180px"> {{ Auth::user()->name }}</span></body></html>'
