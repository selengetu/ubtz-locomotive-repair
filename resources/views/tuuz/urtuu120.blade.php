    ...
    <div class="page-content-wrapper">
        ...
        <div class="page-content">
                ...
                <div class="portlet-title">
                    <div class="caption">
                        ...
                        <span class="caption-subject font-green sbold uppercase">
                            Өртөөнд 120 минутаас дээш зогссон
                        </span>
                    </div>
                ...
                <div id="sear" class="panel-collapse collapse in">
                    <div class="panel-body">
                        <fieldset class="scheduler-border">
                            <form method="post" action="urtuu120">
                                <div class="col-md-12">
                                    <div class="col-md-3">
                                        <div class="form-group form-md-line-input has-success">
                                            <div class="input-icon">
                                                <input class="form-control datepicker" id="urtuu120_start" name="urtuu120_start" type="text"  value="{{$startdate}}" />
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group form-md-line-input has-success">
                                            <div class="input-icon">
                                                <input class="form-control datepicker" id="urtuu120_end" name="urtuu120_end" type="text" value="{{$enddate}}"/>
                                                <label for="form_control_1" style="font-size:12px;">
                                                    Дуусах огноо
                                                </label>
                                                <span class="help-block">
            ...
            <div class="table-container">
                ...
                <p><center><b> {{$startdate}} -аас {{$enddate}} -ны өртөөнд 120 -аас дээш минут зогссон судалгаа</b></center> </p>
...
@section('cscript')
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            $("#urtuu120_start").datepicker({
                format: 'yyyy-mm-dd',
                todayBtn:  1,
                autoclose: true,
            }).on('changeDate', function (selected) {
                var minDate = new Date(selected.date.valueOf());
                $('#urtuu120_end').datepicker('setStartDate', minDate);
            });

            $("#urtuu120_end").datepicker({
                format: 'yyyy-mm-dd',
            })
                .on('changeDate', function (selected) {
                    var minDate = new Date(selected.date.valueOf());
